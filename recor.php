...
<body>
  ...
  <div id="ventana">
    <form id="formularioventana" name="Registrar_Servicio" action="validar/validarcliente.php" method="POST">
      ...
      <input id="nombre" type="text" name="nombre"max-length="20" placeholder="Nombre"/>
      <input id="apellido" type="text" name="apellido" max-length="20" placeholder="Apellido"/>
      <input id="direccion" type="text" name="direccion" max-length="20" placeholder="Direccion"/>
      <input id="telefono" type="number" name="telefono" max-length="20" placeholder="Telefono"/>
      <input id="cedula" type="number" name="cedula" max-length="20" placeholder="Cedula"/>
      <input id="correo" type="email" name="correo" max-length="20" placeholder="Correo"/>
